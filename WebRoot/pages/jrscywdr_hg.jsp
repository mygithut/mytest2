...
<tr height="350">
 <td>
  <iframe src="<%=request.getContextPath()%>/JRSCYWDRHG_List.action" id="downFrame" name="downFrame" width="100%" height="100%" frameborder="0"  marginwidth="0" marginheight="0" scrolling="no"  align="left" style="overflow-x: yes"></iframe> 
  </td>
</tr>
</table>
</body>
<script type="text/javascript">
   function doQuery(){
      var para ="<%=request.getContextPath()%>/JRSCYWDRHG_List.action?pageSize="+j('#pageSize').val()+"&brNo="+encodeURI(j('#brNo').val())+"&cusName="+encodeURI(j('#cusName').val());
