...
function dTree(objName) {
	...
	this.icon = {
		root				: 'pages/js/dtree/img/base.gif',
		folder			: 'pages/js/dtree/img/folder.gif',
		folderOpen	: 'pages/js/dtree/img/folderopen.gif',
		node				: 'pages/js/dtree/img/page.gif',
		empty				: 'pages/js/dtree/img/empty.gif',
		line				: 'pages/js/dtree/img/line.gif',
		join				: 'pages/js/dtree/img/join.gif',
		joinBottom	: 'pages/js/dtree/img/joinbottom.gif',
		plus				: 'pages/js/dtree/img/plus.gif',
		plusBottom	: 'pages/js/dtree/img/plusbottom.gif',
		minus				: 'pages/js/dtree/img/minus.gif',
		minusBottom	: 'pages/js/dtree/img/minusbottom.gif',
		nlPlus			: 'pages/js/dtree/img/nolines_plus.gif',
		nlMinus			: 'pages/js/dtree/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.checkPNode = function(pid,ischecked) {	
	for (var n=0; n<this.aNodes.length; n++) {
		if (this.aNodes[n].pid!=-1&&this.aNodes[n].id <= pid) {			
			eval("document.all."+ this.aNodes[n].cname + "_" + this.aNodes[n].id + ".checked = " + ischecked);			
			//this.checkPNode(this.aNodes[n].id,ischecked);	
			//break;
		}
	}
};
