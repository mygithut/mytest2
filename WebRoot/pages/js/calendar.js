 function atCalendarControl(){
  ...
  this.addCalendarPad=function(){
   document.write("<div id='divCalendarpad' style='position:absolute;top:100;left:0;width:255;height:70;display:none;'>");
   document.write("<iframe frameborder=0 height=40 width=60></iframe>");
   document.write("<div style='position:absolute;top:4;left:4;width:124;height:70;background-color:#336699;'></div>");
   document.write("</div>");
  ...
  this.addCalendarBoard=function(){
   ...
   divBoard.style.cssText="position:absolute;top:0;left:0;width:125;height:70;border:1 outset;background-color:buttonface;";

   var tbBoard=document.createElement("table");
   divBoard.insertAdjacentElement("beforeEnd",tbBoard);
   tbBoard.style.cssText="position:absolute;top:0;left:0;width:50%;height:10;font-size:9pt;";
  ...
  /************** 设置各功能按钮的功能 *********************/
   ...
   calendar.prevMonth.onmousedown=function(){
    ...
    if(calendar.currentDate[1].toString().length==1){
   ...
   calendar.goToday.onclick=function(){
   	...
   	if(calendar.currentDate[2].length<2) calendar.currentDate[2]="0"+calendar.currentDate[2];
   ...
   calendar.nextMonth.onmousedown=function(){
    ...
    if(calendar.currentDate[1].toString().length==1)calendar.currentDate[1]="0"+calendar.currentDate[1];
    calendar.show(calendar.target,calendar.currentDate[0]+"-"+calendar.currentDate[1]+"-"+calendar.currentDate[2],calendar.source);
   }
   ...
   tbBody.style.cssText="position:relative;top:0;left:0;width:180;height:100;font-size:9pt;"
  ...
  this.setDefaultDate=function(){
   ...
   if(calendar.today[1].toString().length==1)calendar.today[1] = ""+"0"+calendar.today[1];
   calendar.today[2]=dftDate.getDate();
   if(calendar.today[2].toString().length==1)calendar.today[2] = ""+"0"+calendar.today[2];
  }
  ...
  this.show=function(targetObject,defaultDate,sourceObject){
   ...
   //alert("offsetPos.y"+offsetPos.y);
   //alert("calendar.source.offsetHeight"+calendar.source.offsetHeight);

   //滚动条下拉的高度
   //alert("document.body.scrollTop"+document.body.scrollTop);

   //alert("calendar.calendarPad.style.pixelHeight"+calendar.calendarPad.style.pixelHeight);
   if((document.body.offsetHeight-(offsetPos.y+calendar.source.offsetHeight-document.body.scrollTop))<calendar.calendarPad.style.pixelHeight){
    var calTop=offsetPos.y+calendar.calendarPad.style.pixelHeight-document.all.Layer1.offsetHeight;
   }
   else{
  ...
  this.insertBodyCell=function(theRow,j,day,targetObject){
   ...
   else if(j==6) var theBgColor="#FF9999";
