...
<html>
		...
		<tr>
			<td>
			     <table width="100%"  class="table"  align="left">
					...
					<tr>
					<td width="10%" align="right">员工编号： </td>
					<td  width="40%" >
					...
					<td width="10%" align="right">员工状态：</td>
					<td colspan="1">
			...
			<tr>
				<td>
					<iframe src="<%=request.getContextPath()%>/YGXXWH_List.action?brNo=<%=telmst.getBrMst().getBrNo()%>" id="iframe" name="iframe" width="100%"	height="350" frameborder="no" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" align="middle"></iframe>
				</td>
			</tr>
		</table>
	</body>
	...
	function doQuery() {
		...
		window.frames.iframe.location.href = "<%=request.getContextPath()%>/YGXXWH_List.action?brNo="+brNo+"&empNo="+empNo+"&empStatus="+empStatus+"&empName="+encodeURI(empName);
	}
	function doClear(){
