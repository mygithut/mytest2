...
<script type="text/javascript" language="JavaScript1.2">
  ...
  function my_check(Form){
     ...
     // Form.action = "<%=request.getContextPath()%>/PTZJRZSYLDCWH_doImport.action";
     // Form.submit();
     $.ajax({
			url:'<%=request.getContextPath()%>/PTZJRZSYLDCWH_doImport.action',
			type: "POST",
			dataType:'json',  
			data: {
  ...
  function doBack() {
	 window.location.href = "<%=request.getContextPath()%>/PTZJRZSYLDCWH_List.action";
  }
 </script>
</head>
...
<form action="" method="post">
 <table class="table" width="80%" align="center">
	<tr>
		<td height="30" colspan="2" align="right"><a href="<%=request.getContextPath()%>/doc/Rate_spread.xls" class="button">下载模板</a></td>
	</tr>
	<tr>
		<th width="36%">
