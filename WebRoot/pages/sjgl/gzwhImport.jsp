...
<script type="text/javascript" language="JavaScript1.2">
  ...
  //先检查是否有文件上传上来了
    ...
    //Form.action = "<%=request.getContextPath()%>/GZWH_doImport.action";
     parent.parent.parent.parent.openNewDiv();
$.ajax({
	url:'<%=request.getContextPath()%>/GZWH_doImport.action',
	type: "POST",
	dataType:'json',  
	data: {
  ...
  function doBack() {
	 window.location.href = "<%=request.getContextPath()%>/GZWH_List.action";
  }
 </script>
</head>
...
<form action="" method="post">
 <table class="table" width="80%" align="center">
	<tr>
		<td height="30" colspan="2" align="right"><a href="<%=request.getContextPath()%>/doc/Stock_yield.xls" class="button">下载模板</a></td>
	</tr>
	<tr>
		<th width="36%">
