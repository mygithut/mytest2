...
<script type="text/javascript" language="JavaScript1.2">
  ...
  $.ajax({
			url:'/ftp/JRSCYWDRXQMM_doImport.action',
			type: "POST",
			dataType:'json',  
			data: {
  ...
  function ok(){
     window.location.href ='/ftp/distribute.action?url=JRSCYWDRXQMM';
  }
  function doReload() {
...
<body>
<form action="/ftp/JRSCYWDRXQMM_doImport.action" method="post" id="doImport" name="doImport" enctype="multipart/form-data">
<%Integer successNum = (Integer)request.getAttribute("successNum");
 %>
<table class="table" width="80%" align="center">
	<tr>
		<td height="30" colspan="2" align="right"><a href="<%=request.getContextPath()%>/doc/xqmm.xls" class="button">下载模板</a></td>
	</tr>
	<tr>
		<th width="36%">
		...
		<td height="30" colspan="2">
			...
			<input type="button" name="Submit1" value="导&nbsp;&nbsp;入"
							...
							<input type="button" name="Reset" value="重&nbsp;&nbsp;置" class="button"
								onclick="javaScript:window.location.reload();"></div>
		</td>
	</tr>
</table>
<BR/>
