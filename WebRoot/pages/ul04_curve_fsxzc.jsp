...
for(int i = 0; i < keyRate.length; i++) {
	System.out.println("keyRate"+keyRate[i]);
}
SCYTCZlineF F = SCYTCZ_Compute.getSCYTCZline(key, keyRate);
     %>
<div id="container" style="width: 980px; height: 330px" align="center"></div>
