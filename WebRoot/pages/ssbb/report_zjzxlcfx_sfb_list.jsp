					...
					<tbody>
						<tr>
							<td align="center" width="250">
								<font style="font-weight:bold">资产交易额</font>
							</td>
							<td align="center" width="250">
								<font style="font-weight:bold"><%=FormatUtil.toMoney(ylfxReport.getZcye()/10000)%></font>
							</td>
						</tr>
						<tr>
							<td align="center" width="250">
						...
						<tr>
							<td align="center" width="250">
								<font style="font-weight:bold">负债交易额</font>
							</td>
							<td align="center" width="250">
								<font style="font-weight:bold"><%=FormatUtil.toMoney(ylfxReport.getFzye()/10000)%></font>
							</td>
						</tr>
						<tr>
							<td align="center" width="250">
						...
						<tr>
							<td align="center" width="250">
								<font style="font-weight:bold">净收入
							</td>
							<td align="center" width="250">
								<font style="font-weight:bold"><%=FormatUtil.toMoney((ylfxReport.getZczyzc()-ylfxReport.getFzzysr())/10000)%></font>
							</td>
						</tr>
					</tbody>
				</table>
...
function doExport() {
	window.parent.document.thisform.action='<%=request.getContextPath()%>/pages/ssbb/report_zjzxlcfx_sfb_export.jsp';
