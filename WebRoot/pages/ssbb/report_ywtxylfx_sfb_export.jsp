...
<%
String filename = new String(("业务条线盈利分析报表_试发布").getBytes("GBK"),"ISO-8859-1");   
...
<table border="1" align="center" id="">
     <tr>
      <th align="center" colspan="18"><font style="color:#333; font-size:18px;font-weight:bold">业务条线盈利分析报表_试发布</font></th>
     </tr>
     <tr >
