...
<%
String filename = new String(("机构总盈利分析报表_试发布").getBytes("GBK"),"ISO-8859-1");   
...
<table align="center" id="" border="1" >
     <tr>
      <th align="center" colspan="18"><font style="color:#333; font-size:18px;font-weight:bold">机构总盈利分析报表_试发布</font></th>
     </tr>
     <tr >
