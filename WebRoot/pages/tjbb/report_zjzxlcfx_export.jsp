...
<%
String filename = new String(("资金中心利差分析报表").getBytes("GBK"),"ISO-8859-1");   
...
<table border="1" align="center" id="" width="600">
     <tr>
      <th align="center" colspan="2"><font style="color:#333; font-size:18px;font-weight:bold">资金中心利差分析报表</font></th>
     </tr>
     <tr >
