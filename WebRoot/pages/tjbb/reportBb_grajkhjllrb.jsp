...
<html>
	<head>
		<title>统计报表-个人按揭分客户经理FTP利润明细表</title>
	...
	<body>
		<div class="cr_header">
			当前位置：统计报表->个人按揭报表->个人按揭分客户经理FTP利润明细表
		</div>
...
<%--										onClick="doRefresh()" value="刷新缓存数据"> --%>
    ...
    function changeAssessScope(assessScope) {
	 ...
	 function doQuery(){
			...
			var url ="<%=request.getContextPath()%>/REPORTBB_grajkhjllrbReport.action";
			new Ajax.Request(url, {
				...
				onSuccess : function() {
					document.getElementById("downFrame").src="pages/tjbb/reportBb_grajkhjllrb_list.jsp"; 
			    }
		    });
		}
