...
<html>
	<head>
		<title>统计报表-机构业务条线FTP利润汇总表</title>
...
function doQuery(){
	...
	var url ="<%=request.getContextPath()%>/REPORTBB_jgywtxlrhzbReport.action";
	new Ajax.Request(url, {
		...
		onSuccess : function() {
			document.getElementById("downFrame").src="pages/tjbb/reportBb_jgywtxlrhzb_list.jsp"; 
	    }
    });
}
