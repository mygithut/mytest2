...
.ui-datepicker-calendar {
	...
	<body>
		<div class="cr_header">
			当前位置：统计报表->个人按揭产品报表->个人按揭机构FTP利润表
		</div>
...
function doQuery(){
	...
	var url ="<%=request.getContextPath()%>/REPORTBB_grajjglrbReport.action";
	new Ajax.Request(url, {
		...
		onSuccess : function() {
			document.getElementById("downFrame").src="pages/tjbb/reportBb_grajjglrb_list.jsp"; 
	    }
    });
}
