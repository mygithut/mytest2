...
<%--										onClick="doRefresh()" value="刷新缓存数据"> --%>
    ...
    function changeAssessScope(assessScope) {
	 ...
	 function doQuery(){
			...
			var url ="<%=request.getContextPath()%>/REPORTBB_gsywbmxbReport.action";
			new Ajax.Request(url, {
				...
				onSuccess : function() {
					document.getElementById("downFrame").src="pages/tjbb/reportBb_gsywblrmxb_list.jsp";
			    }
		    });
		}
