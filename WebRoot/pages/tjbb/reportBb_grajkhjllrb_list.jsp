			...
			<tr>
				<td>
					<div style="width: 1000; height: 260; overflow: auto;" id="dv">
						<table id="tableList" class="table" align="left" width="1780" 
							cellpadding="0" cellspacing="0">
							<tr>
								<td class="middle_header" colspan="16">
									<font
										style="padding-left: 10px; color: #333; font-size: 12px; font-weight: bold">个人按揭分客户经理FTP利润明细表
									</font>
								</td>
							</tr>
							<tr>
								...
								<th align="center" width="260" class="td_relative">
									机构名称
								</th>
								<th align="center" width="200" class="td_relative">
									客户经理名称
								</th>
								<th align="center" width="100" class="td_relative">
									账号
								</th>
								<th align="center" width="200" class="td_relative">
									客户名称
...
<!-- 								<th align="right" width="120" class="td_relative">
     ...
     %>
							<tr>
								...
								<td align="right"><%=CommonFunctions.doublecut(entity.getRate(),6)%></td>
...
<%-- 								<td align="right">
								...
								<td align="right">
									<font style="font-weight: bold"><%=CommonFunctions.doublecut(ratefz/rjye,3)%></font>
								</td>
								<td align="right">
			...
			<tr>
				<td colspan="12">
					<table border="0" width="100%" class="tb1"
						...
						align="center">
						<tr>
							<td align="right"><%=grajkhjllrbReportUtil.getPageLine()%>
							</td>
						</tr>
					</table>
...
function doExport() {
	window.location.href='<%=request.getContextPath()%>/REPORTBB_grajkhjllrbExport.action';
}
</script>
<style type="text/css">
