...
<body>
	<form id="form1" name="form1" method="get" action="">
		<%
PageUtil sykhjllrmxbReportUtil = (PageUtil)session.getAttribute("sykhjllrmxbReportUtil");
List<YlfxBbReport> ylfxBbReportList = sykhjllrmxbReportUtil.getList();
String minDate = (String)session.getAttribute("sykhjllrmxbMinDate");
String maxDate = (String)session.getAttribute("sykhjllrmxbMaxDate");
String brName = (String)session.getAttribute("sykhjllrmxbBrName");
...
%>
			...
			<tr>
				<td>
					<div style="width: 1000; height: 260; overflow: auto;" id="dv">
						<table id="tableList" class="table" align="left" width="2000"
     ...
     %>
							<tr>
								...
								<td align="center" width="350"><%=entity.getBrName()+"["+entity.getBrNo()+"]"%></td>
								<td align="center" width="250"><%=entity.getEmpName()+"["+entity.getEmpNo()+"]"%></td>
								<td align="center" width="200"><%=entity.getAcId()%></td>
								<td align="center" width="250"><%=entity.getPrdtName()%></td>
								<td align="center" width="200"><%=entity.getCustName()%></td>
								<td align="center" width="70"><%=(entity.getOpnDate().equals("")||entity.getOpnDate()==null||entity.getOpnDate().equals("null"))?"-":entity.getOpnDate()%></td>
								<td align="center" width="70"><%=(entity.getMtrDate().equals("")||entity.getMtrDate()==null||entity.getMtrDate().equals("null"))?"-":entity.getMtrDate()%></td>
								<td align="right" width="100"><%=FormatUtil.toMoney(entity.getBal())%></td>
								<td align="right" width="100"><%=FormatUtil.toMoney(entity.getRjye())%></td>
								<td align="right" width="120"><%=FormatUtil.toMoney(entity.getRjye()*days)%></td>
								<td align="right" width="70"><%=CommonFunctions.doublecut(entity.getRate()*100,6)%></td>
								<td align="right" width="80"><%=entity.getFtp()==-999?"-":CommonFunctions.doublecut(entity.getFtp()*100,6)%></td>
								<td align="right" width="70"><%=CommonFunctions.doublecut(entity.getLc()*100,6)%></td>
								<td align="right" width="80"><%=FormatUtil.toMoney(entity.getFtplr())%></td>
							</tr>
							<%} %>
							<tr>
								<td align="center">
			...
			<tr>
				<td colspan="12">
					<table border="0" width="100%" class="tb1"
						...
						align="center">
						<tr>
							<td align="right"><%=sykhjllrmxbReportUtil.getPageLine()%>
							</td>
						</tr>
					</table>
...
function doExport() {
	...
	window.location.href='<%=request.getContextPath()%>/REPORTBB_yhkhjltjbbExport.action?page='+page;
}
</script>
<style type="text/css">
