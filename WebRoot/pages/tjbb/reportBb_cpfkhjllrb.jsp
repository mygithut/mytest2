...
<html>
	<head>
		<title>统计报表-产品分客户经理FTP利润表</title>
		<link rel="stylesheet"
...
<%--										onClick="doRefresh()" value="刷新缓存数据">--%>
				...
				<tr height="350">
					<td align="left" height="350">
						<iframe src="" id="downFrame" width="100%" height="100%"
	...
	function doQuery(){
		...
		var url ="<%=request.getContextPath()%>/REPORTBB_cpfkhjllrbReport.action";
		new Ajax.Request(url, {
			...
			onSuccess : function() {
				document.getElementById("downFrame").src="pages/tjbb/reportBb_cpfkhjllrb_list.jsp"; 
		    }
	    });
	}
