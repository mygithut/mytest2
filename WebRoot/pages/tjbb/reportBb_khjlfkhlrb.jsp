...
<html>
	<head>
		<title>统计报表-客户经理分客户FTP利润表</title>
	...
	<body>
		<div class="cr_header">
			当前位置：统计报表->客户经理报表->客户经理分客户FTP利润表
		</div>
...
<%--										onClick="doRefresh()" value="刷新缓存数据"> --%>
				...
				<tr height="350">
					<td align="left" height="350">
						<iframe src="" id="downFrame" width="920" height="100%"
...
function doQuery(){
	...
	var url ="<%=request.getContextPath()%>/REPORTBB_khjlfkhlrbReport.action";
	new Ajax.Request(url, {
		...
		onSuccess : function() {
			document.getElementById("downFrame").src="pages/tjbb/reportBb_khjlfkhlrb_list.jsp"; 
	    }
    });
}
