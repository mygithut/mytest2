...
<table width="80%" border="0" align="center">
  ...
  <table width="900" border="0" align="left" class="table">
	...
	<tr>
		   ...
		   <tr height="350">
		      <td align="left">
		        <iframe src="" id="downFrame" width="917" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="auto" align="middle"></iframe> 
		      </td>
		   </tr>
		</table>
 </form>
...
function doQuery(){
	if(!(isNull(document.getElementById("brNo"),"机构"))) {
	   ...
	   window.frames.downFrame.location.href ='<%=request.getContextPath()%>/UL03_getResultPrice.action?brNo='+brNo+'&pageSize='+document.getElementById('pageSize').value;
	}
</script>
</html>
