 ...
 * @author 孙红玉
 * 
 * @date Oct 11, 2012 3:47:54 PM
 * 
 * @version 1.0
 */
public class DuozjcpzAction extends BoBuilder {
	...
	public String list() throws Exception {
		ftpPoolInfoBO.getFtpPoolInfo(request, brNo, "3");
		return "list";
	}
	...
	public String save() throws Exception {
		ftpPoolInfoBO.saveFtpPoolInfo(request, brNo, "3", poolNos, poolNames, poolTypes, contentObjects);
		return null;
	}
