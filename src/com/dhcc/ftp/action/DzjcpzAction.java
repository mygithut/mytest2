 ...
 * @version 1.0
 */
public class DzjcpzAction extends BoBuilder {
	...
	public String list() throws Exception {
		ftpPoolInfoBO.getFtpPoolInfo(request, brNo, "1");
		return "list";
	}
	...
	public String save() throws Exception {
		ftpPoolInfoBO.saveFtpPoolInfo(request, brNo, "1",  poolNos, poolNames, poolTypes, contentObjects);
		return null;
	}
