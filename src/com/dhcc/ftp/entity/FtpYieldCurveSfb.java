...
public class FtpYieldCurveSfb implements java.io.Serializable {
	...
	/** default constructor */
	public FtpYieldCurveSfb() {
	}

	/** minimal constructor */
	public FtpYieldCurveSfb(String curveId) {
		this.curveId = curveId;
	}

	/** full constructor */
	public FtpYieldCurveSfb(String curveId, String curveNo, Double a3, Double b2,
