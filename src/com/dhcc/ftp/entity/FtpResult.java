...
public class FtpResult  implements java.io.Serializable {
    ...
    public FtpResult(String resultId) {
        this.resultId = resultId;
    }
    public FtpResult(String resultId,String prcMode,String prcMethod,Double resultPrice,Double afresValue,AlmCur almCur,BrMst brMst,String poolNo,String memo, String resDate) {
    	this.resultId=resultId;
