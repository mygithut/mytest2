...
public class FtpShiborDAO extends DaoFactory {
	private DaoFactory factory=new DaoFactory();
	private static final Log log = LogFactory.getLog(FtpShiborDAO.class);
	...
	public PageUtil dofind(int page) {
		String pageName = "";
		pageSize = 10;
		hql = "from FtpShibor order by shiborDate desc,shiborRate";//substr(shiborTerm,2,1),substr(shiborTerm,1,1)";
		pageName = "SHIBORWH_List.action?";
		FtpShiborUtil = this.queryPage(hql, null, pageSize, page, -1,pageName);
