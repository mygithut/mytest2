...
public class FtpCreditRatingDAO extends DaoFactory {
	private DaoFactory factory=new DaoFactory();
	private static final Log log = LogFactory.getLog(FtpCreditRatingDAO.class);
	...
	public PageUtil dofind(int page) {
		String pageName = "";
		pageSize = 10;
		hql = "from FtpCreditRating";
		pageName = "UL04_list.action?";
		FtpPoolUtil = this.queryPage(hql, null, pageSize, page, -1,pageName);
		return FtpPoolUtil;
	}
