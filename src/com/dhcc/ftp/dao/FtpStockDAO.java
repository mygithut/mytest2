...
public class FtpStockDAO extends DaoFactory {
	private DaoFactory factory=new DaoFactory();
	private static final Log log = LogFactory.getLog(FtpStockDAO.class);
	...
	public PageUtil dofind(int page) {
		String pageName = "";
		pageSize = 10;
		hql = "from FtpStockYield order by stockDate desc,to_number(substr(stock_term,1,LENGTH(stock_term)-1))";
		pageName = "GZWH_List.action?";
